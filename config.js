...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || '𓆩ســورس ريبـــثون يــعـمـل بنجــاح𓆪/nالمستخدم:{sender}/nوقت التشغيل:{uptime}/nالاصدار:{VERSION}'
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://imgur.com/a/6SpaXJE.jpg;‏https://chat.whatsapp.com/JYLHUhNouuaD2Xs7Xngyfh',
